...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      className="fixed bottom-6 right-6 z-40 block h-14 w-14 rounded-full shadow-lg shadow-[#25D366]/40 transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-xl active:scale-[0.97] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#25D366]"
